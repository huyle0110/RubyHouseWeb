...
namespace RubyHouseWeb
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            // Sweetalertmaster
            bundles.Add(new ScriptBundle("~/bundles/sweetAlertMaster/js").Include(
                      "~/Vendor/bootstrap-sweetalert-master/dist/sweetalert.min.js"));

            // SweetalertMaster style
            bundles.Add(new StyleBundle("~/bundles/sweetAlertMaster/css").Include(
                      "~/Vendor/bootstrap-sweetalert-master/dist/sweetalert.css"));
